    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{ backgroundColor: "rgb(16 21 33)", color: "#06D001" }}
        >
          <h1>
            <span>Fruits</span>
          </h1>
          ...
          <Row className="justify-content-center px-5">
            {fruits.map((fruit, index) => (
              <Col
                ...
                lg={4}
                key={index}
                className="mb-4 d-flex justify-content-center p-1"
              >
                <Card
                  style={{
                    width: "18rem",
                ...
                >
                  ...
                  <Card.Body>
                    <Card.Title style={{ color: "#90EE90" }}>
                      {fruit.name}
                    </Card.Title>
                    <Card.Text>
                      <div
                        className="text-bg-light border rounded mt-1 text-center"
                    ...
                    >
                      {getItemQuantity(fruit) === 0 ? (
                        ...
                        <p
                          className="border border-black rounded w-50"
                          style={{
